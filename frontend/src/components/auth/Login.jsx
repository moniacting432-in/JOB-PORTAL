      ...
      <div className="flex items-center justify-center max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="my-2">
            ...
            <Input
              type="password" // ✅ corrected spelling
              value={input.password} // ✅ use correct state key
              name="password"
              onChange={changeEventHandler}
            ...
            <RadioGroup className="flex items-center gap-4 my-5">
              <div className="flex items-center space-x-2">
                <Input
                  ...
                  name="role"
                  value="student"
                  checked={input.role === "student"} // ✅ fixed checked
                  onChange={changeEventHandler}
              ...
              <div className="flex items-center space-x-2">
                <Input
                  ...
                  name="role"
                  value="recruiter"
                  checked={input.role === "recruiter"} // ✅ fixed checked
                  onChange={changeEventHandler}
                  className="cursor-pointer"
                />
